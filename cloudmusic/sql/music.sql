...
create table music(
	...
	Music_style varchar2(20),--歌曲类型
	Music_singer varchar2(20)--歌曲演唱者
...
create table album(
	...
	Album_picpath varcahr2(40),-- 专辑图片 
	Album_another1 varcahr2(40),--预留字段1
	Album_another2 varcahr2(40),--预留字段2
...
create table collect(
	...
	User_id int references User(User_id),--创建人id(属于用户表)
...
create table sclist(
	...
	Sclist_another1 varcahr2(40),--预留字段1
...
create table enshrine(
	...
	Enshrine_another1 varcahr2(40),
	Enshrine_another2 varcahr2(40) 
)
...
User_id int references User(User_id),--
Collect_id references collect(Collect_id),--引用collect_id(外键)
Gedanlist_another1 varcahr2(40),
Gedanlist_another2 varcahr2(40),
...
Comment_id int primart key ,-- id（主键）
